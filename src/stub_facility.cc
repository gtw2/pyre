...
void StubFacility::GetMatlTrades(
...
void StubFacility::AcceptMatlTrades(
...
std::set<cyclus::BidPortfolio<Material>::Ptr> StubFacility::GetMatlBids(
...
bool StubFacility::CheckDecommissionCondition() {
  if (leftover.count() > 0) {
    return false;
  }
...
void StubFacility::RecordPosition() {
